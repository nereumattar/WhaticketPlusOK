...
```bash
sudo apt install -y git && git clone https://github.com/nereumattar/WhaticketPlusOK.git && sudo chmod -R 777 what-plus && cd WhaticketPlusOK && sudo ./Instalawhaticketplus
```
